...
#[代码] 查询纯真IP数据库
#发信站: 水木社区 (Wed Mar  1 11:47:28 2006), 转信
#
#主要程序还是这里看来的:
#http://blog.daviesliu.net/article/entry20050518-192847
#
#修改了一点地方，最主要的就吧数据库一次都读入到内存里面
...
def main():
  i = IPInfo(r'E:\Speed2007IIBeta2\Speed2007IIBeta2\QQ\QQWry.Dat')
