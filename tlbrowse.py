...
class TypeBrowseDialog(TypeBrowseDialog_Parent):
	...
	def GetTemplate(self):
		...
		w = 572  # Dialog width
		h = 492  # Dialog height
		style = FRAMEDLG_STD | win32con.WS_VISIBLE | win32con.DS_SETFONT | win32con.WS_MINIMIZEBOX | win32con.WS_MAXIMIZEBOX
		...
		template.append([131, None, self.IDC_MEMBERLIST, (100, 20, 80, 80), LBS_STD| 2])
		...
		template.append(["SysListView32", "", self.IDC_LISTVIEW, (10, 110, 255, 265), lvStyle])
